    ...
    <div class="form-group">
        ...
        <div class="row mb-3">
            <div class="col-6">
                ...
                <select id="first" class="form-control form-control-sm @error('first') is-invalid @enderror"
                    name="first">
            ...
            <div class="col-6">
                ...
                <select id="second" class="form-control form-control-sm date @error('second') is-invalid @enderror"
                    name="second">
                    <option value="" selected>Without User</option>
                    @foreach ($second as $d)
